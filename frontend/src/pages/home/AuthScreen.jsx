	...
	return (
		<div className='hero-bg relative'>
			...
			<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
				<img src='/logo2.png' alt='Netflix Logo' className='w-32 md:w-52' />
				<Link to={"/login"} className='text-white bg-myColor-500 py-1 px-2 rounded-md'>
					Sign In
				</Link>
			</header>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				<h1 className='text-4xl md:text-6xl font-bold mb-4'>Watch movies, TV shows, and more</h1>
				<p className='text-lg mb-4'>Ready to watch? Enter your email to create or login your account</p>

				<form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
					<input
						type='email'
						placeholder='Email address'
						className='p-2 rounded flex-1 bg-black/80 border border-gray-700 rounded-lg'
						value={email}
						onChange={(e) => setEmail(e.target.value)}
					/>
					<button className='bg-myColor-500 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded-lg flex justify-center items-center'>
          Let’s Zen!
